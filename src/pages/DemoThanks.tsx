        ...
        <div className="max-w-2xl mx-auto">
          ...
          <div className="rounded-2xl p-6 sm:p-8 border border-white/10 bg-white/[0.03] mb-6">
            ...
            <div className="text-center mb-6">
              ...
              <a href={`tel:${DEMO_PHONE.replace(/\s/g, '')}`} className="inline-flex items-center gap-3 px-8 py-4 rounded-2xl bg-gradient-to-r from-[#22c55e]/20 to-[#22c55e]/10 border-2 border-[#22c55e]/40 text-[#22c55e] font-bold text-2xl sm:text-3xl hover:scale-105 transition-all">
            ...
            <div className="text-center">
              ...
              <a href={`https://wa.me/44${DEMO_PHONE.replace(/^0/, '').replace(/\s/g, '')}`} target="_blank" rel="noopener noreferrer" className="inline-flex items-center gap-2 px-6 py-3 rounded-xl border border-[#22c55e]/30 text-[#22c55e] text-sm font-medium hover:bg-[#22c55e]/10 transition-colors">
